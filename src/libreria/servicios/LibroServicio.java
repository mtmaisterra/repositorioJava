 ...
 Scanner leer =new Scanner(System.in).useDelimiter("\n");
  ...
  EditorialServicio eS= new EditorialServicio();
        ...
        do {
            ...
            if (libro.getTitulo() == null) {
                ...
                do {
                    ...
                    try {
                        List<Autor> autores = lD.consultaGenerica("Autor", "nombre", nombreAutor);
                ...
                do {
                    ...
                    try {
                        List<Editorial> editoriales = lD.consultaGenerica("Editorial", "nombre", nombreEditorial);
    ...
    public Libro buscarLibroIsbn() {
        ...
        System.out.println("Ingrese el ISBN del libro");
        long isbn = leer.nextLong();
        Libro libro = (Libro) lD.buscarPorIsbn(isbn);
        if (libro != null) {
    ...
    public Libro buscarLibroTitulo(String tituloLibro) {
        boolean noEncontrado = true;
        List<Libro> libros = lD.consultaGenerica("Libro", "titulo", tituloLibro);
        if (!libros.isEmpty()) {
    ...
    public void buscarLibroAutor() {
        System.out.println("Ingrese el nombre del autor");
        String nombreAutor = leer.next();
        List<Libro> librosCoincidentes = lD.consultaGenerica("Libro", "autor.nombre", nombreAutor);
    ...
    public void buscarLibroEditorial() {
        System.out.println("Ingrese el nombre de la editorial");
        String nombreEditorial = leer.next();
        List<Libro> librosCoincidentes = lD.consultaGenerica("Libro", "editorial.nombre", nombreEditorial);
        if (librosCoincidentes.isEmpty()) {
    ...
    public List<Libro> buscarLibroAutor(String autor) {
        return lD.consultaGenerica("Libro", "autor.nombre", autor);
    }

    public List<Libro> buscarLibroEditorial(String editorial) {
        return lD.consultaGenerica("Libro", "editorial.nombre", editorial);
    }
